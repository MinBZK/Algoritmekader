...
Een andere situatie is het doorvoeren van wezenlijke wijzigingen, al dan niet op verzoek van opdrachtgever, aan de al ingekochte algoritmen en AI. Dat kan betekenen dat opnieuw aan bepaalde normen moet worden getoetst. Bepaalde werkzaamheden moeten dan opnieuw  worden uitgevoerd. Hierbij kan worden gedacht aan het uitvoeren van een bias analyse of het ondergaan van een conformiteitsbeoordeling als het gaat om hoge risico AI-systemen. 
