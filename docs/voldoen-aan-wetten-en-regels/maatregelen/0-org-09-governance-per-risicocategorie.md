...
!!! example "Gemeente Rotterdam: Processchema governance"
    ...
    * Is het voorstelbaar dat de algoritmetoepassing uitmondt in een onrechtvaardige handeling van de gemeente tegen burgers of bedrijven?
    ...
    ![De afbeelding laat een stroomschema zien om tot de juiste governance te komen zoals het door de gemeente Rotterdam wordt gehanteerd. De afbeelding komt uit een presentatie gegeven in februari 2022. Eerst voer je een <lang=en>Algorithm Risk Assessment</lang=en> uit. Als op de alle drie de zojuist genoemde vragen nee wordt beantwoord, is de standaard governance van de gemeente van toepassing. Eventueel kan de proceseigenaar een DEDA of DPIA uitvoeren. Daarna kan het algoritme naar het reguliere beheer. Als er op minstens één van de vragen ja is geantwoord, is de algoritmegovernance van toepassing. Dit betekent allereerst dat het algoritme wordt opgenomen in het openbaar Algoritmeregister. Vervolgens wordt de vraag gesteld of er persoonsgegevens worden gebruikt. Zo ja, dan moet een DPIA en een IAMA worden uitgevoerd. De proceseigenaar, privacy-officer, functionaris gegevensbescherming, ontwikkelaar en een algoritme-expert moeten hierbij zijn betrokken. Vervolgens komt het algoritme in de algoritme-governancecyclus terecht. Worden er geen persoonsgegevens gebruikt, dan hoeft alleen een IAMA te worden uitgevoerd en moeten alleen de proceseigenaar, ontwikkelaar en een algoritme-expert worden betrokken. Ook na het IAMA komt het algoritme dan in de algoritme-governancecyclus.](../../afbeeldingen/rotterdam_risico_classificatie_governance.png)
