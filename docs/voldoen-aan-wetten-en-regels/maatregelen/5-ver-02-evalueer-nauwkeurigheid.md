...
- Bepaal welke foutmarge acceptabel is:
    ...
    - Heb hierbij aandacht voor de [afweging tussen nauwkeurigheid en betrouwbaarheid](../../onderwerpen/technische-robuustheid-en-veiligheid.md#wat-is-technisch-robuust-en-veilig). Een model met hoge nauwkeurigheid op de testset kan vaak slechter 
...
### Metrieken
Afhankelijk van het type algoritme zijn er verschillende metrieken voor nauwkeurigheid, zoals:
