...
Deze vereiste is ook van toepassing bij het ontwikkelen en gebruiken van algoritmes en stelt daarmee beperkingen aan het mogen verwerken van deze categorieën persoonsgegevens, bv. ten behoeve van trainingsdata of het genereren van de beoogde output. Deze gegevens mogen gebruikt worden voor biasdetectie en -correctie, mits:
- dit niet mogelijk is met synthetische of geanonimiseerde data;
- het technisch onmogelijk wordt gemaakt om ze te hergebruiken en ze worden gepseudonimiseerd;
- ze niet gedeeld worden met derden;
- ze worden verwijderd nadat de bias is gecorrigeerd of bij het verstrijken van de bewaartermijn;
- het gebruik van deze gegevens wordt opgenomen in het verwerkingsregister.
...
- [Artikel 4a AI-verordening]((https://eur-lex.europa.eu/legal-content/NL/TXT/?uri=CELEX:32026R1744)) (toegevoegd in het AI-omnibuspakket)
