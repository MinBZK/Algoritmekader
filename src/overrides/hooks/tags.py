...
def on_page_markdown(markdown: str, *, page: Page, config: MkDocsConfig, files: Files):
    ...
    def replace_ai_act(_: Match):
        ...
        if not page.meta.get("id").startswith("urn:nl:ak:ver:aia-"):
            ...
            toelichting = "Deze vereiste is van toepassing voor onderstaande (combinatie van) labels. Gebruik de <a href=\"#\" onclick=\"showModal(event, 'beslishulp AI-verordening', {redirectUrl: 'vereisten/'});\">beslishulp AI-verordening</a> voor hulp bij wat er in jouw situatie van toepassing is. <br/> <br/>"
